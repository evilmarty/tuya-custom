...
class DPCode(StrEnum):
    ...
    ADD_MOISTURE_SENSOR = "AddMoisureSensor" # Add Moisture Sensor
    ADD_RAIN_SENSOR = "AddRainSensor" # Add Rain Sensor
    ...
    MANUAL_SWITCH = "ManualSwitch" # Manual Switch
    MANUAL_TIMER = "ManualTimer" # Manual Timer
    MATERIAL = "material"  # Material
    MODE = "mode"  # Working mode / Mode
    MOISTURE = "Moisure" # Moisture
    MOISTURE_POWER_STATUS = "MoisurePowerStatus" # Moisture Power Status
    ...
    RAIN = "Rain"
    RAIN_POWER_STATUS = "RainPowerStatus"
    ...
    STOP_IRRAGATION = "Stopirrigation" # Stop Irratation
    SUCTION = "suction"
    ...
    _TEMP = "Temp" # Because consistency is not a thing :(
    TEMP_BOILING_C = "temp_boiling_c"
    TEMP_BOILING_F = "temp_boiling_f"
    TEMP_CONTROLLER = "temp_controller"
    TEMP_CURRENT = "temp_current"  # Current temperature in °C
    TEMP_CURRENT_F = "temp_current_f"  # Current temperature in °F
    TEMP_FORMAT = "TempFormat" # Temperature Format
    ...
    TIMER_DELAY = "TimerDelay" # Timer Delay
